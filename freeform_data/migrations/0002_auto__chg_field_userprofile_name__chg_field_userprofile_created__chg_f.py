...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('freeform_data_userprofile', 'name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.created'
        db.alter_column('freeform_data_userprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'UserProfile.modified'
        db.alter_column('freeform_data_userprofile', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'UserProfile.role'
        db.alter_column('freeform_data_userprofile', 'role', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'UserProfile.organization'
        db.alter_column('freeform_data_userprofile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['freeform_data.Organization'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.name'
        db.alter_column('freeform_data_userprofile', 'name', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.created'
        db.alter_column('freeform_data_userprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=''))

        # Changing field 'UserProfile.modified'
        db.alter_column('freeform_data_userprofile', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=''))

        # Changing field 'UserProfile.role'
        db.alter_column('freeform_data_userprofile', 'role', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'UserProfile.organization'
        db.alter_column('freeform_data_userprofile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['freeform_data.Organization']))
