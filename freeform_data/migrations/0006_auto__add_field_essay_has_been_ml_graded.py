...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Essay.has_been_ml_graded'
        db.add_column('freeform_data_essay', 'has_been_ml_graded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Essay.has_been_ml_graded'
        db.delete_column('freeform_data_essay', 'has_been_ml_graded')
