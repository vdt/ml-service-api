...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EssayGrade.confidence'
        db.add_column('freeform_data_essaygrade', 'confidence',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EssayGrade.confidence'
        db.delete_column('freeform_data_essaygrade', 'confidence')
