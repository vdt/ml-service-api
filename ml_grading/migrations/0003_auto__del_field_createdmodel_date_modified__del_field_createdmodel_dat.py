...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreatedModel.date_modified'
        db.delete_column('ml_grading_createdmodel', 'date_modified')

        # Deleting field 'CreatedModel.date_created'
        db.delete_column('ml_grading_createdmodel', 'date_created')

        # Adding field 'CreatedModel.modified'
        db.add_column('ml_grading_createdmodel', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CreatedModel.created'
        db.add_column('ml_grading_createdmodel', 'created',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CreatedModel.date_modified'
        raise RuntimeError("Cannot reverse this migration. 'CreatedModel.date_modified' and its values cannot be restored.")
        # Adding field 'CreatedModel.date_created'
        db.add_column('ml_grading_createdmodel', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 27, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'CreatedModel.modified'
        db.delete_column('ml_grading_createdmodel', 'modified')

        # Deleting field 'CreatedModel.created'
        db.delete_column('ml_grading_createdmodel', 'created')
